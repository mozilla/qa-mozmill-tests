...
function setupModule(module) {
  ...
  controller.open("chrome://selenium-ide/content/tests/functional/aut/checksandradios.html");
...
function testVerifyNotCheckedCommandPasses() {
  sm.addCommand({action: "verifyNotChecked",
