...
tabBrowser.prototype = {
  ...
  closeTab : function tabBrowser_closeTab(aEventType, aIndex) {
    ...
    this._controller.window.addEventListener("TabClose", checkTabClosed);
    ...
    try {
      ...
      this._controller.window.removeEventListener("TabClose", checkTabClosed);
  ...
  openInNewTab : function tabBrowser_openInNewTab(aTarget, aEventType) {
    ...
    var self = { opened: false, transitioned: false };
    ...
    this._tabs.getNode().addEventListener("transitionend", checkAnimationEnded);
    ...
    try {
      ...
      this._tabs.getNode().removeEventListener("transitionend", checkAnimationEnded);
    }
  },
