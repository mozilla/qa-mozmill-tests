...
addonsManager.prototype = {
  ...
  get paneId() {
    ...
    return /\w+/.exec(selected.getNode().id)[0];
  },
  ...
  set paneId(id) {
    ...
    }, "Pane has been selected. Expected pane id: '" + id + "'", undefined,
       undefined, this);
  },
  ...
  close : function addonsManager_close(force) {
    ...
    if (this._controller) {
      ...
      }, "Addons Manager has been closed");
      this._controller = null;
    }
  },
  ...
  setPluginState : function addonsManager_setPluginState(node, value, enable) {
    ...
    }, "Plugin has changed state. Expected '" + subtype + "'", undefined,
       undefined, this);
  },
