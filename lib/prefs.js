...
preferencesDialog.prototype = {
  ...
  get paneId() {
    ...
    this._controller.waitFor(function () {
      var currentPaneId = selector.getNode().selectedItem.getAttribute('pane');
      return currentPaneId === this.selectedPane.getNode().id;
    }, "Pane has been changed. Expected id: '" + this.selectedPane.getNode().id +
  ...
  set paneId(id) {
    ...
    }, "Pane has been changed. Expected id: '" + id + "'");
    return this.paneId;
  },
