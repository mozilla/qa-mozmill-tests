...
engineManager.prototype = {
  ...
  set selectedIndex(index) {
    ...
    }, "Search engine has been selected. Expected index: '" + index + "'",
  ...
  removeEngine : function engineManager_removeEngine(name) {
    ...
    }, "Search engine has been removed. Expected: '" + name + "'",
       undefined, undefined, this);
  },
...
searchBar.prototype = {
  ...
  set selectedEngine(name) {
    ...
    this._controller.waitFor(function () {
      return this.selectedEngine === name;
    }, "Search engine has been selected. Expected '" + name + "'", undefined,
       undefined, this);
  },
  ...
  checkSearchResultPage : function searchBar_checkSearchResultPage(searchTerm) {
    ...
    var locationBar = new toolbars.locationBar(this._controller);
    var loadedURL = locationBar.value;

    this._controller.assert(function () {
      return loadedURL.toLowerCase().indexOf(searchTerm.toLowerCase()) >= 0;
    }, "Current URL contains the search term - got '" +
      loadedURL.toLowerCase() + "', expected '" + searchTerm.toLowerCase() + "'");
  },
  ...
  type : function searchBar_type(searchTerm) {
    var searchBar = this.getElement({type: "searchBar_input"});
