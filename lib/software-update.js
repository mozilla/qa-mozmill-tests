...
//    }
  ...
  forceFallback : function softwareUpdate_forceFallback() {
    ...
    // Check the version of Firefox used and select the appropriate constant
    var version = utils.appInfo.version.split(".")[0];
    var updatePath = (version < 21) ? "XCurProcD" : "UpdRootD";

    updateDir = Services.dirsvc.get(updatePath, Ci.nsIFile);
