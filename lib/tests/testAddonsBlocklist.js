...
const ADDONS = [
  {name : "Restartless Addon",
   url : LOCAL_TEST_FOLDER + "extensions/restartless.xpi"},
  {name : "Inline Settings (Restartless)",
   url : LOCAL_TEST_FOLDER + "extensions/restartless_inlinesettings.xpi"}
];
const BLOCKLIST_URL = LOCAL_TEST_FOLDER + "blocklist/" +
                      "mixedblock_extension/blocklist.xml";
