...
/**
 * Testcase ID #8053 - Disabling Cookies
 */
...
var testDisableCookies = function()
{
  ...
  PrefsAPI.preferencesDialog.open(prefDisableCookieDialogCallback);
  ...
  PrefsAPI.preferencesDialog.open(prefCheckDisableDialogCallback);
}
